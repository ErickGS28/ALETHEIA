  ...
  return (
    <Card className="border-dashed">
      <CardContent className="flex flex-col items-center justify-center gap-3 py-14 text-center">
        ...
        <p className="max-w-sm text-sm font-sans text-muted-foreground">
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-12 text-center">
      ...
      {description ? (
        <p className="max-w-sm text-sm font-sans text-muted-foreground">{description}</p>
      ) : null}
      {action}
    </div>
  );
...
export function LoadingState({ message }: { message?: string }) {
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-12 text-center">
      <Spinner size="md" className="text-foreground/60" />
      <p className="text-sm font-sans text-muted-foreground">{message ?? 'Cargando…'}</p>
    </div>
  );
}
